...
data_type list_pop_item(List* dll,int(*data_cmp_fn)(void* list_item,void* item), void* item); // Pop a choose item
 ...
 *
 */
void list_destroy(List *l,void(*data_destroy_fn)(void* data));
